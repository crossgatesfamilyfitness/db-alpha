...
public partial class UserGroupSubscriptionPriceDetail
{
    ...
    public uint UserGroupSubscriptionPriceDetailId { get; set; }

    public uint UserGroupSubscriptionPriceId { get; set; }

    public uint UserGroupSubscriptionBillingOptionId { get; set; }
