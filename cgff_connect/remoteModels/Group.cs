...
public partial class Group
{
    ...
    public virtual ICollection<GroupMembershipBilling> GroupMembershipBillings { get; } = new List<GroupMembershipBilling>();
    ...
    public virtual ICollection<MembershipFee> MembershipFees { get; } = new List<MembershipFee>();
    ...
    public virtual ICollection<Group> Addons { get; } = new List<Group>();

    public virtual ICollection<EventCustomDate> EventCustomDates { get; } = new List<EventCustomDate>();

    public virtual ICollection<EventCustomFee> EventCustomFees { get; } = new List<EventCustomFee>();

    public virtual ICollection<EventCustomParam> EventCustomParams { get; } = new List<EventCustomParam>();
